    ...
    <div className="bg-white">
      <div className="mx-auto max-w-3xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        ...
        <div className="mt-10 border-t border-zinc-200">
          <div className="mt-10 flex flex-auto flex-col">
            ...
            <p className="mt-2 text-sm text-zinc-600">
              Мы считаем, что кружка не только должна хорошо выглядеть, но и
              служить долгие годы. Мы предлагаем недельную гарантию на проверку,
              так как уверены в уверены в качестве материалов и скурпулезности
              работы.
            </p>
          </div>
        </div>
        ...
        <div>
          ...
          <div className="grid grid-cols-2 gap-x-6 border-t border-zinc-200 py-10 text-sm">
            ...
            <div>
              ...
              <p className="mt-2 text-zinc-700">Доставка занимает до 3 дней</p>
            </div>
          </div>
        </div>
        ...
        <div className="space-y-6 border-t border-zinc-200 pt-10 text-sm">
          ...
          <div className="flex justify-between">
            <p className="font-medium text-zinc-900">Итог</p>
            <p className="text-zinc-700">{formatPrice(amount)}</p>
          </div>
        </div>
      </div>
