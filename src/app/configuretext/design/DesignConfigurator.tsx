        ...
        <ScrollArea className="relative flex-1 overflow-auto">
          ...
          <div className="px-8 pb-12 pt-8">
            ...
            <div className="relative flex flex-col gap-3 w-full">
              <Label className="font-bold text-lg">Текст</Label>
              <Input
                name="title"
                type="text"
                value={userText}
                onChange={(e) => setUserText(e.target.value)}
                className="inline-flex items-center whitespace-nowrap rounded-md text-m font-medium border h-9 px-4 py-2 data-[hover]:bg-accent hover:text-accent-foreground data-[focus]:bg-gray-100"
              />
              <Button
                isLoading={isPending}
                disabled={isPending}
